...
// Comet data (Halley's Comet-like)
export const COMET_DATA = {
  name: 'Comet',
  semiMajorAxis: 150,       // AU scaled
  eccentricity: 0.967,       // Very elliptical
  inclination: 0.3,          // Slight tilt
  orbitalPeriod: 76,         // Years
  facts: {
    type: 'Periodic Comet',
    orbitalPeriod: '~76 Earth years',
    composition: 'Ice, dust, and rock',
    tailLength: 'Millions of kilometers near Sun',
    feature: 'Tail always points away from Sun'
  }
};
